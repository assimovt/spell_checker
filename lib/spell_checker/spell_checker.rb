class SpellChecker
  ...
  # Public: Correct a word and provide suggestions.
  #
  # word - The String word to be corrected
  #
  # Returns the unique array of suggestions
  def correct(word)
    return word if dictionary.has_key?(word)
    (known_candidates(edits(word)) or edits_2(word)).uniq
  end
